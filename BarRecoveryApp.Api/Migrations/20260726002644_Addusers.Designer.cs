...
namespace BarRecoveryApp.Api.Migrations
{
    ...
    [Migration("20260726002644_Addusers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarRecoveryApp.Api.Entities.Bar", b =>
                {
                    ...
                    b.HasIndex("PlantId", "BarTypeId", "BarNumber")
                        .IsUnique();

                    b.ToTable("bars", (string)null);
                });

            modelBuilder.Entity("BarRecoveryApp.Api.Entities.BarReturnReceipt", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("bar_return_receipts", (string)null);
                });

            modelBuilder.Entity("BarRecoveryApp.Api.Entities.BarReturnReceiptBar", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("BarReturnReceiptId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("BarReturnReceiptId");

                    b.ToTable("bar_return_receipt_bars", (string)null);
                });
            ...
            modelBuilder.Entity("BarRecoveryApp.Api.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BarRecoveryApp.Api.Entities.BarReturnReceiptBar", b =>
                {
                    b.HasOne("BarRecoveryApp.Api.Entities.BarReturnReceipt", null)
                        .WithMany("Bars")
                        .HasForeignKey("BarReturnReceiptId")
