    ...
    public class SyncBackgroundRunner : ISyncBackgroundRunner, IDisposable
    {
        ...
        private async Task RunOnceSafeAsync()
        {
            ...
            try
            {
                ...
                try
                {
                    var barSyncEngine = scope.ServiceProvider.GetRequiredService<IBarSyncEngine>();
                    await barSyncEngine.SyncAsync();
                }
                catch (Exception)
                {
                    // TODO: logging centralizado.
                ...
                try
                {
                    var userSyncEngine = scope.ServiceProvider.GetRequiredService<IUserSyncEngine>();
                    await userSyncEngine.SyncAsync();
                }
                catch (Exception)
                {
                    // TODO: logging centralizado.
